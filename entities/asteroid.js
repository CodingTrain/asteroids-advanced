...
Asteroid.prototype.splitAt = function(impactPos, levelmanager) {
  ...
  var pos1_offset = new p5.Vector(0, 0, 0), pos2_offset = new p5.Vector(0, 0, 0);
  var rad1 = -1, rad2 = -1;
  ...
  world.addEndFrameTask(function() {
    world.createEntity(Asteroid, { pos: p5.Vector.add(scope.pos, pos1_offset), r: rad1, vertices: asteroid1_vertices, vel: pos1_offset.normalize(), heading: scope.heading, levelmanager: levelmanager });
    world.createEntity(Asteroid, { pos: p5.Vector.add(scope.pos, pos2_offset), r: rad2, vertices: asteroid2_vertices, vel: pos2_offset.normalize(), heading: scope.heading, levelmanager: levelmanager });
  });
}
